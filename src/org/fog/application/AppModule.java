...
public class AppModule extends PowerVm{
    ...
    public java.util.List<org.fog.entities.Tuple> getResultantTuples(String inputTupleType, org.fog.entities.Tuple inputTuple, int sourceDeviceId, int sourceModuleId) {
        // The default behavior is to produce no new tuples.
        // Custom modules like your ContextGeneratorModule will override this logic.
        return new java.util.ArrayList<org.fog.entities.Tuple>();
    }
