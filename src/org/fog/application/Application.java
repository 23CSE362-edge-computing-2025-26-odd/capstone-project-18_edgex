...
public class Application {
    ...
    //ADDED METHOD BY MEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
    /**
     * Adds an already created application module to the application.
     * @param module The application module to be added.
     */
        ...
        for(AppEdge edge : getEdges()){
            if(edge.getSource().equals(moduleName)){
                ...
                if(selectivityModel.canSelect()){
                    ...
                    String newTupleType = edge.getTupleType(); // Get the default type from the edge
                    if (moduleName.equals("context-generator-module")) {
                        Random random = new Random();
                        String traffic = random.nextBoolean() ? "HIGH" : "LOW";
                        String weather = random.nextBoolean() ? "RAINY" : "CLEAR";
                        newTupleType = "CONTEXT_TUPLE_" + traffic + "_" + weather;
                        System.out.println("ContextGeneratorModule is generating new context: " + newTupleType);
                    }
                    ...
                    tuple.setTupleType(newTupleType); // Use the new dynamic type
